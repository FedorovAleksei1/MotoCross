...
namespace Moto.Infrastructure.Migrations
{
    ...
    [Migration("20230801143753_fix_card_wiht_operation")]
    partial class fix_card_wiht_operation
    {
            ...
            modelBuilder.Entity("Domain.Models.CardNameOnputMoney", b =>
                {
                    ...
                    b.HasIndex("CardId")
                        .HasDatabaseName("IX_CardNamePutMoneys_CardId");
            ...
            modelBuilder.Entity("Domain.Models.CardNameOnputMoney", b =>
                {
                    b.HasOne("Domain.Models.Card", "Card")
                        .WithOne("CardNameOnputMoney")
                        .HasForeignKey("Domain.Models.CardNameOnputMoney", "CardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
