...
using Moto.Core.Services.AdminService.AdminUserInfoService;
...
using Moto.Core.Services.UserRoleService;
using Moto.Web.Middlewares;
...
namespace MotoCross
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IFormedTeamService, FormedTeamService>();
